...
<div class="container mx-auto p-6 flex flex-col items-center">
    <div class="slider">
        <div class="slides">
            ...
            <div class="slide"><img src="https://th.bing.com/th/id/OIP.lKZEvi5FVDDmG-mB65j6YQHaE8?rs=1&pid=ImgDetMain" alt="About courses" class="w-full" /></div>
...
<section class="container mx-auto py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div class="bg-white p-4 shadow-md">
            <img src="{{ $course->image_url }}" alt="{{ $course->title }}" class="w-full h-32 object-cover mb-4">
            <h3 class="text-xl font-semibold">{{ $course->title }}</h3>
            <p class="text-gray-700">{{ $course->description }}</p>
            <a href="{{ $course->link }}" class="text-blue-600 hover:underline">Submit</a>
        </div>
        @endforeach
    </div>
</section>
